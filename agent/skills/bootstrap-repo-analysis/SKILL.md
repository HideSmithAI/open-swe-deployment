...
```
GH_TOKEN="${OPEN_SWE_GITHUB_TOKEN:-dummy}" gh pr list --repo <owner>/<repo> --state merged --limit 30
GH_TOKEN="${OPEN_SWE_GITHUB_TOKEN:-dummy}" gh api repos/<owner>/<repo>/pulls/<PR_NUMBER>/reviews
GH_TOKEN="${OPEN_SWE_GITHUB_TOKEN:-dummy}" gh api repos/<owner>/<repo>/pulls/<PR_NUMBER>/comments
GH_TOKEN="${OPEN_SWE_GITHUB_TOKEN:-dummy}" gh api repos/<owner>/<repo>/issues/<PR_NUMBER>/comments
```
